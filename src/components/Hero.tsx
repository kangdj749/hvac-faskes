  ...
  return (
    <section className="relative flex items-center justify-center w-full min-h-[90vh] overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 text-center text-white px-6 md:px-10 space-y-6 max-w-3xl"
      >
        <h1 className="font-extrabold leading-tight text-[clamp(1.9rem,5vw,3.6rem)] drop-shadow-lg">
        ...
        {/* Trust Badge */}
        <div className="flex flex-wrap justify-center gap-3 text-xs sm:text-sm text-green-100/80 mt-4">
          <span className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            14+ Tahun Pengalaman HVAC
          </span>
          <span className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            Standar Higienis Fasilitas Kesehatan
          </span>
          <span className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            Respon Cepat
          </span>
