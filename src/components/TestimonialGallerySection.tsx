...
export default function TestimonialGallerySection() {
  const gallery = [
    ...
    { src: "/gallery/mulia1.webp", alt: "Perawatan AHU fasilitas kesehatan" },
    { src: "/gallery/mulia2.webp", alt: "Pembersihan filter AC ruang tindakan" },
    { src: "/gallery/mulia3.webp", alt: "Pembersihan filter AC ruang tindakan" },
    ...
    { src: "/gallery/service1.webp", alt: "Perawatan berkala gedung klinik" },
    ...
    { src: "/gallery/service4.webp", alt: "Perawatan berkala gedung klinik" },
    ...
    { src: "/gallery/service7.webp", alt: "Perawatan berkala gedung klinik" },
    { src: "/gallery/service8.webp", alt: "Perawatan berkala gedung klinik" },
    { src: "/gallery/service9.webp", alt: "Servis AC outdoor unit" },
    { src: "/gallery/service10.webp", alt: "Servis AC outdoor unit" },
    { src: "/gallery/service11.webp", alt: "Servis AC outdoor unit" },
